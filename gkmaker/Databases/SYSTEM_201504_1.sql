...
CREATE TABLE `pa_game` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='赛事管理' ;
...
CREATE TABLE `pa_teacher` (
  ...
  `aid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='名师讲座' ;
...
# 数据库表：pa_admin 数据信息
INSERT INTO `pa_admin` VALUES ('1','超级管理员','764302375@qq.com','4210358bf7a994805c6ad250b6c21f50','1','我是超级管理员 哈哈~~','','1428826720');
...
INSERT INTO `pa_chuangyi` VALUES ('1','创青春','陈洪杨','Hello  world!','1409653448','350','1','chytth','54');
INSERT INTO `pa_chuangyi` VALUES ('2','Hello','科研立项','不错的','0','350','0','chytth','34');
INSERT INTO `pa_chuangyi` VALUES ('3','3D打印机','3D打印技术','供热规定vfd','1409907701','350','1','admin','31');
INSERT INTO `pa_chuangyi` VALUES ('4','3D打印机','非常不错','非常不错','1409909034','350','0','admin','43');
INSERT INTO `pa_chuangyi` VALUES ('5','3D打印机','非常不错','非常不错','1409909048','350','0','admin','63');
INSERT INTO `pa_chuangyi` VALUES ('6','3D打印机','3D打印机','3D打印机','1409909057','350','0','admin','29');
INSERT INTO `pa_chuangyi` VALUES ('7','3D打印机','3D打印机','3D打印机','1409909063','350','0','admin','30');
INSERT INTO `pa_chuangyi` VALUES ('8','3D打印机','3D打印机3D打印机','3D打印机','1409909071','350','0','admin','28');
INSERT INTO `pa_chuangyi` VALUES ('9','3D打印机','3D打印机','3D打印机','1409909078','350','0','admin','33');
INSERT INTO `pa_chuangyi` VALUES ('10','3D打印机','3D打印机','3D打印机','1409909085','350','0','admin','0');


# 数据库表：pa_clickcount 数据信息
INSERT INTO `pa_clickcount` VALUES ('1','4009','0');


# 数据库表：pa_download 数据信息
INSERT INTO `pa_download` VALUES ('3','<a href="/gkmaker/Uploads/file/20140904/20140904023558_48347.doc" target="_blank">你懂的，点击下载。</a>','1409798172','0','1');
INSERT INTO `pa_download` VALUES ('6','<a href="/gkmaker/Uploads/file/20140905/20140905150630_53552.doc" target="_blank">重要文件，误删！！！</a>','1409922402','0','0');
...
INSERT INTO `pa_file` VALUES ('10','5440ed2a9cce7.doc','1413541162','日語愛好者協會','0','2','0');
INSERT INTO `pa_file` VALUES ('11','551bb7b729cdf.doc','1427879863','第一十四届挑战杯申请表下载','0','2','0');
INSERT INTO `pa_file` VALUES ('12','551bb8fb5d770.doc','1427880187','第一十四届挑战杯申请表下载','0','2','0');


# 数据库表：pa_game 数据信息
INSERT INTO `pa_game` VALUES ('48','1','第十四届“挑战杯”全国大学生课外学术科技作品竞赛校内选拔赛的通知','','0','近日，我校师生参加第28届中国大学生手球锦标赛、第十二届全国大学生攀岩锦标赛、第三届全区大学生田径比赛等体育赛事屡获佳绩，捷报频传。手球队扬威第28届全国大学生手球锦标赛7月20日下午，由中国大学生体育协会手球分会主办，南京工程学院承办的第28届中国大学生手球锦标赛在天健苑·体育中心落下帷幕。本届比赛共有来自中国内地、香港和澳门等地19所高校26支运动队400余名运动员参加了3个组别的角逐。我校代&hellip;','1427879554','','<p style="text-indent:32px;">
	<br />
</p>
...
</p>','1','','','2014-10-7','2014-10-12','随后进行了题为《梦聚南宁》的文艺演出，演出融汇武术、民族歌舞、体操表演等形式，通过会鼓、绣球、壮锦、朱槿花、银饰等最具代表性的广西元素与第四十五届世界体操锦标赛运动主题的结合，既展现出广西12个世居民族丰富多彩的民族风情，又体现出运动员顽强拼搏、勇于竞争的奥林匹克精神。');
...
INSERT INTO `pa_home_game` VALUES ('54','00','7','1','00','00','00','00','0','','','');
INSERT INTO `pa_home_game` VALUES ('55','','0','0','','','','','0','','','');
...
INSERT INTO `pa_relannounce` VALUES ('14','第二届广西科学节展览','<p class="MsoNormal" style="text-indent:24.0pt;">
...
INSERT INTO `pa_science` VALUES ('7','51','3244','123123','31232323','0','323232323','1409538319','343244','1');


# 数据库表：pa_teacher 数据信息
INSERT INTO `pa_teacher` VALUES ('1','9','二季度房地产信托','','随着安信信托、中信信托等多家信托公司曝出房地产信托计划的兑付风险，部分房地产投资私募基金(PE)已在...','0','<div class="content"><p>随着安信<a href="http://licai.so/Trust/" target="_blank">信托</a>、<a href="http://licai.so/Trust/agency-1061/" target="_blank">中信信托</a>等多家信托公司曝出房地产信托计划的兑付风险，部分房地产投资<a href="http...','1363141340','1413381153','<div class="content">
	<p>
...
INSERT INTO `pa_teacher` VALUES ('2','14','银监会拟引入','','银行理财业务的迅猛增长，倒逼监管的步步升级。','0','银行理财业务的迅猛增长，倒逼监管的步步升级。记者从业内获得的最新统计数据显示，截至2012年末，各银行共存续理财产品32152款，理财资金账面余额7.1万亿元，比2011年末增长约55%。年初以来，银监会已将理财业务列为今年的重点监管工作。消息人士透露，对理财产品加大监管主要表现在两方面：一是将派出机构对银行理财产品销售活动进行专项检查；另一方面，将“资金池”操作模式作为现场检查的重点，“要求商业…','1363141499','1413381151','银行理财业务的迅猛增长，倒逼监管的步步升级。
<p>
...
INSERT INTO `pa_teacher` VALUES ('3','1','武汉理工大学应邀来我校作学术报告','武汉理工大学博导程艳霞教授应邀来我校作学术报告','武汉理工大学博导程艳霞教授应邀来我校作学术报告','0','武汉理工大学博导程艳霞教授应邀来我校作学术报告','1413381143','1418965180','<p style="text-align:center;text-indent:2em;">
...
INSERT INTO `pa_teacher` VALUES ('4','1','吴军博士应邀来我校作学术报告','吴军博士应邀来我校作学术报告','吴军博士应邀来我校作学术报告','0','吴军博士应邀来我校作学术报告','1413381256','1418965183','<p style="text-align:center;text-indent:28px;">
...
INSERT INTO `pa_teacher` VALUES ('5','1','2014“中国－东盟大讲坛”在我校开讲','2014“中国－东盟大讲坛”第三期在我校开讲','2014“中国－东盟大讲坛”第三期在我校开讲','0','2014“中国－东盟大讲坛”第三期在我校开讲','1413465325','1418965186','<p>
...
INSERT INTO `pa_teacher` VALUES ('6','1','《宗元大讲堂》讲座','《宗元大讲堂》讲座','《宗元大讲堂》讲座','0','《宗元大讲堂》讲座','1413465385','1418965188','<p>
...
INSERT INTO `pa_zonenotice` VALUES ('4','欢迎您加入大学生科创中心！！方便的话，上传个自己的头像哈，让大家都互相认识下。<img src="http://gkmaker.gxbykj.com/Public/kindeditor/plugins/emoticons/images/0.gif" border="0" alt="" />','1408893151','1','1413617840');
...
INSERT INTO `pa_zonenotice` VALUES ('7','<img src="http://localhost:88/gkmaker/Public/kindeditor/plugins/emoticons/images/10.gif" border="0" alt="" />','1408893241','0','1413617995');
INSERT INTO `pa_zonenotice` VALUES ('9','<img src="http://localhost:88/gkmaker/Public/kindeditor/plugins/emoticons/images/30.gif" border="0" alt="" />','1408893256','0','1413617999');
INSERT INTO `pa_zonenotice` VALUES ('11','<img src="http://localhost:88/gkmaker/Public/kindeditor/plugins/emoticons/images/22.gif" border="0" alt="" />','1408893276','0','1413618003');
