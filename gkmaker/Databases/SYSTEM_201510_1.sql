...
CREATE TABLE `pa_download` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='下载文件' ;
...
# 数据库表：pa_admin 数据信息
INSERT INTO `pa_admin` VALUES ('1','超级管理员','925066365@qq.com','3db822b28ee7c9a516f1c5d8871c409f','1','我是超级管理员 哈哈~~','','1444186752');
...
INSERT INTO `pa_clickcount` VALUES ('1','4045','0');
...
# 数据库表：pa_file 数据信息
INSERT INTO `pa_file` VALUES ('11','551bb7b729cdf.doc','1427879863','第一十四届挑战杯申请表下载','0','1','0');
