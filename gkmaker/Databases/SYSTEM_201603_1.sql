...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：pa_academy、pa_access、pa_addadvice、pa_admin、pa_advice、pa_category、pa_chuangyi、pa_clickcount、pa_download、pa_email、pa_file、pa_game、pa_grade、pa_guestbook、pa_gundong、pa_home_game、pa_home_pionner、pa_introduction、pa_major、pa_member、pa_messageboard、pa_news、pa_node、pa_ourmaker、pa_relannounce、pa_role、pa_role_user、pa_science、pa_teacher、pa_venture、pa_vip、pa_zonenotice的结构信息，表：pa_academy、pa_access、pa_addadvice、pa_admin、pa_advice、pa_category、pa_chuangyi、pa_clickcount、pa_download、pa_email、pa_file、pa_game、pa_grade、pa_guestbook、pa_gundong、pa_home_game、pa_home_pionner、pa_introduction、pa_major、pa_member、pa_messageboard、pa_news、pa_node、pa_ourmaker、pa_relannounce、pa_role、pa_role_user、pa_science、pa_teacher、pa_venture、pa_vip、pa_zonenotice的数据
# Time: 2016-03-28 20:19:08
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------


# 数据库表：pa_academy 结构信息
DROP TABLE IF EXISTS `pa_academy`;
CREATE TABLE `pa_academy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `academy` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `pa_home_game` (
  ...
  `game_id` int(10) DEFAULT NULL COMMENT '比赛id',
  PRIMARY KEY (`id`),
  KEY `game_id` (`game_id`)
...
CREATE TABLE `pa_member` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=378 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='网站前台会员表' ;
...
# 数据库表：pa_academy 数据信息
INSERT INTO `pa_academy` VALUES ('1','医学院');
INSERT INTO `pa_academy` VALUES ('2','土木与建筑学院');
INSERT INTO `pa_academy` VALUES ('3','汽车与交通学院');
INSERT INTO `pa_academy` VALUES ('4','电气与信息工程学院');
INSERT INTO `pa_academy` VALUES ('5','计算机学院');
INSERT INTO `pa_academy` VALUES ('6','体育学院');
INSERT INTO `pa_academy` VALUES ('7','机械工程学院');
INSERT INTO `pa_academy` VALUES ('8','财经学院');
INSERT INTO `pa_academy` VALUES ('9','社会科学学院');
INSERT INTO `pa_academy` VALUES ('10','管理学院');
INSERT INTO `pa_academy` VALUES ('11','理学院');
INSERT INTO `pa_academy` VALUES ('12','艺术学院');
INSERT INTO `pa_academy` VALUES ('13','化学与生物工程学院');
INSERT INTO `pa_academy` VALUES ('14','外国语学院');
INSERT INTO `pa_academy` VALUES ('15','继续教育学院');
...
INSERT INTO `pa_chuangyi` VALUES ('1','创青春','陈洪杨','Hello  world!','1409653448','350','1','chytth','68');
INSERT INTO `pa_chuangyi` VALUES ('3','豪','哦哦','哦哦哦哦哦哦哦哦哦哦哦','1454208035','374','1','root','1');
INSERT INTO `pa_chuangyi` VALUES ('5','回事哦','你的佛啊是的看法恶劣','的你曾经恶劣的看法进啦士大夫哦哦 东风恶了','1454208248','374','1','root','0');


# 数据库表：pa_clickcount 数据信息
INSERT INTO `pa_clickcount` VALUES ('1','7184','0');
...
# 数据库表：pa_grade 数据信息
INSERT INTO `pa_grade` VALUES ('1','2013级');
INSERT INTO `pa_grade` VALUES ('2','2014级');
INSERT INTO `pa_grade` VALUES ('3','2015级');
INSERT INTO `pa_grade` VALUES ('4','2016级');
INSERT INTO `pa_grade` VALUES ('5','2017级');


# 数据库表：pa_guestbook 数据信息
INSERT INTO `pa_guestbook` VALUES ('18','我的世界','冼杰豪','我的世界是一款游戏','1454056528','','374','','');
INSERT INTO `pa_guestbook` VALUES ('19','南方城市','南方城市','南方城市','1454056632','','0','','');
INSERT INTO `pa_guestbook` VALUES ('20','创科天下','菲娜','的念佛即是空点积分快速的法律','1454058365','','0','','');
INSERT INTO `pa_guestbook` VALUES ('21','发撒旦发','负担','哦啊是份额的方式','1454062666','','0','','');
INSERT INTO `pa_guestbook` VALUES ('22','东风恶','娜娜','的份额士大夫哦','1454062761','','0','','');
INSERT INTO `pa_guestbook` VALUES ('23','的发生的','测试','收费额发撒旦发','1454062784','','0','','');
...
INSERT INTO `pa_home_game` VALUES ('20','冼杰豪','13','0','问我','22','11','12351','0','','','','50');
INSERT INTO `pa_home_game` VALUES ('23','朗讯','11','0','得到','333333','55455','333','0','我的世界','蓝讯瑞','得到大是大非得到大是大非','51');
INSERT INTO `pa_home_game` VALUES ('24','南浔瑞','1','2','软件工程','201345555','452584','5455','0','软工13级','龙芯哈u','我们是来自广科大的创业团队','51');
INSERT INTO `pa_home_game` VALUES ('25','孙菲菲','3','3','方法是','22','33','11','0','南方人','宿舍的','顶顶顶顶顶','51');
INSERT INTO `pa_home_game` VALUES ('26','宿舍','14','2','鹦鹉','4545','56','4568','0','兰兰','对对','深深的方式收到的是额度','51');
INSERT INTO `pa_home_game` VALUES ('27','龙打瞎','2','2','大鱼','1454','545','454','0','喜玛拉呀','汤某人','顶顶顶','51');
INSERT INTO `pa_home_game` VALUES ('28','','0','0','','','','','0','','','','51');
INSERT INTO `pa_home_game` VALUES ('29','cc','2','1','ss','445','452584','4568','0','nn','bb','sss','51');
INSERT INTO `pa_home_game` VALUES ('30','龙中庭','2','1','软件工程','201400526165','516351663515','565156','0','','','','51');
INSERT INTO `pa_home_game` VALUES ('31','测试','14','2','软件工程','123123','123123','123123','0','','','','51');
...
INSERT INTO `pa_member` VALUES ('374','0','','root','冼杰豪','50c7dab6be9b2ac2e0b340725cd43163','56ad805e6502d.jpg','','1','','广西','梧州','我是冼杰豪 大家好','2013','155577270293','925066365','','','计算机学院','软件工程','星座控,互联网,高富帅','3');
...
INSERT INTO `pa_member` VALUES ('377','0','','fengxun','','6c38f34ea70c7e7cfca8c6bca7626076','','','','','','','','','','','','','','','','0');
