...
$(function(){
    ...
    <div class="menu">
        ...
        <div class="per_notebook">
            <div class="tab_1">
                <ul>
                    <li ><a href="#"><span>密保设置</span></a></li>
                    <li class="select"><a href="?show=editpwd"><span>修改密码</span></a></li>
                </ul>
            </div>
            <br />
            <form action="__GROUP__/Myzone/secureqa" method="post">
                <table width="329" border="0" cellpadding="0" cellspacing="0" class="table_1">
                    <colgroup><col width="70" /><col /></colgroup>
                    <tr>
                        <th width="126">旧密码：</th>
                        <td width="203"><input type="password" name="info1[oldpsw]" class="input_2" /></td>
                    </tr>
                    <tr>
                        <th>新密码：</th>
                        <td><input type="password" name="info1[pwd]" class="input_2" /></td>
                    </tr>
                    <tr>
                        <th>确认新密码：</th>
                        <td><input type="password" name="info1[confirmpwd]" class="input_2" /></td>
                    </tr>
                    <td colspan="2" class="tc">

                        <br />
                        <input name="button" type="submit" class="btn_2" value="确定修改" /></td>
                    </tr>
                </table>
            </form>
        </div>
