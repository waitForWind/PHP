 ...
 <body>
   ...
   <div class="daohang_a"  id="mynav">
     <div class="daohang">
       ...
       <div class="guangzhu">
         &nbsp;&nbsp;
         <a href="http://weibo.com/u/3268258883" target="_blank">
             ...
             <div class="news_L">
               ...
               <div class="news_L_a">
                 ...
                 <div class="look">
                   ...
                   <div class="ninfo">
                     日期：<?php echo (date("Y-m-d H:i:s",$info["published"])); ?>&nbsp;&nbsp;&nbsp;浏览次数:204
                   </div>
                   ...
                   <div class="news_R_a_M_m">
                     <ul>
                         <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li>
                                 <a href="__GROUP__/News/index/show/new/nid/<?php echo ($new["id"]); ?>"><?php echo ($new["keywords"]); ?></a>
