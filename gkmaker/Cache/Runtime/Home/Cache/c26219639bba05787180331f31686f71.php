    ...
    <div class="menu">
        ...
        <div class="right">
            <div class="per_notebook">
                <h2 class="tit_3">状态</h2>
                <form id="form_id" action="__GROUP__/Myzone/state" method="post">
                    <div class="note_list">
                        <input type="radio" value="1" name="state" <?php if($info[0]['state'] == 1): ?>checked="checked"<?php endif; ?>
                    />有项目，求组队
                    <br />
                    <br />
                    <input type="radio" value="2" name="state" <?php if($info[0]['state'] == 2): ?>checked="checked"<?php endif; ?>
                />无项目，求组队
                <br />
                <br />
                <input type="radio" value="3" name="state" <?php if($info[0]['state'] == 3): ?>checked="checked"<?php endif; ?>
            />最近没有项目或者组队意向
            <br />
            <br />
            <input type="hidden" value="<?php echo ($info[0]["uid"]); ?>" name="id" />
            <input class="btn_2" type="submit" value="确认修改" name="button"></div>
    </form>
</div>
</div>
