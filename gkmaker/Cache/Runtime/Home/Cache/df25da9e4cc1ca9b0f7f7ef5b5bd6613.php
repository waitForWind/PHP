        ...
        <div class="per_notebook">
            ...
            <!--<form id="form_id">-->
                <?php if(is_array($info1)): $i = 0; $__LIST__ = $info1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$in): $mod = ($i % 2 );++$i;?><div class="note_list">
                    ...
                    <dl>
                        <dt><a href="__GROUP__/Myzone/mymessage/id/<?php echo ($in["post"]); ?>" id="author">
				...
				<span class="fr">
                    ...
                    <a href="javascript:void(0);" onclick="reply_content(1073)" >回复</a>　<a  href="__GROUP__/Myzone/getdel?id=<?php echo ($in["id"]); ?>&uid=<?php echo ($info[0]["uid"]); ?>" >删除</a>
				</span>
