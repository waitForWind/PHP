...
<div class="wrap">
    ...
    <div class="right">
        <div class="per_notebook">
            <h2 class="tit_3">创意管理</h2>
            <!--<a class="btn_1" style="float:right; margin-right:10px;" href="#">-->
            <a style="float:right; margin-right:10px;" href="__GROUP__/Chuangyi/index">
                <span><input type="button" value="发表创意"></span>
            </a>
            <form id="form_id" action="?action=state" method="post">

                <table border="0" cellspacing="0" cellpadding="0" class="table_2">
                    <colgroup><col width="60" /><col /><col width="110" /><col width="110" /><col width="60" /></colgroup>
                    <tr>
                        <th width="70">序号</th>
                        <th width="171">标题</th>
                        <th width="128">发表时间</th>
                        <th width="87">操作</th>

                    </tr>
                    <?php if(is_array($ideas)): $i = 0; $__LIST__ = $ideas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$idea): $mod = ($i % 2 );++$i;?><tr align="center">
                        <td class="tc"><?php echo ($i); ?></td>
                        <td><a  href="shownews.php?show=news&nid=277" target="_blank"><?php echo ($idea["title"]); ?></a></td>
                        <td class="tc"><?php echo (date("Y-m-d H:i:s",$idea["time"])); ?></td>
                        <td class="time"><a href="#">修改</a>|<a href="#" onClick="return confirm('确定删除吗')">删除</a></td>
...
<div class="jieshu_a">
    ...
    <div class="jieshu_a_a">
        <a href="http://www.kjjlpt.com/aboutus.php"> <strong>关于我们</strong></a>
    </div>
    <div class="jieshu_a_b">
        <strong>|</strong>
    </div>
    <div class="jieshu_a_a">
        <a href="http://www.kjjlpt.com/aboutus.php"> <strong>联系我们</strong></a>
    </div>
    <div class="jieshu_a_b">
        <strong>|</strong>
    </div>
    ...
    <div class="jieshu_a_a">
        <a href="http://www.kjjlpt.com/showuser.php?uid=1"> <strong>申请链接</strong></a>
    </div>
</div>
