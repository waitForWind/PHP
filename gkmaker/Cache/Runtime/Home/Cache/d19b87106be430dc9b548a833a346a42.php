                            ...
                            <div class="news_L">
                                ...
                                <div class="news_L_a">
                                    <div class="news_L_a_top">
                                        <div class="place">
                                            当前位置：
                                            <a href="index.php">首页</a> > <strong>创意中心</strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="look">
                                        ...
                                        <div class="look_a">
                                            <h1 class="title"><?php echo ($idea["title"]); ?></h1>
                                        </div>
                                        <div class="ninfo">
                                            日期：<?php echo (date("Y-m-d H:i:s",$idea["time"])); ?>&nbsp;&nbsp;&nbsp;浏览次数:<?php echo ($idea["count"]); ?>
                                        </div>
      ...
      <div class="news_R_b_a_A">
        ...
        <div class="jieshu_c">
            ...
            <div class="footer">
                ...
                <br /> Copyright 2012-2014&nbsp;by&nbsp;
                <a href="http://cms.yunstudio.net" target="_blank">Yuncms</a> &nbsp;All&nbsp;Rights&nbsp;Reserved&nbsp;&nbsp;
