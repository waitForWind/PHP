...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="__PUBLIC__/Css/logger.js"></script><link href="__PUBLIC__/Css/bdsstyle.css" rel="stylesheet" type="text/css">
</head>
...
<div class="wrap">
    ...
    <div class="right">
        <div class="per_notebook">
            <h2 class="tit_3">留言板</h2>
            <form id="form_id">
                <?php if(is_array($liuyan)): $i = 0; $__LIST__ = $liuyan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$in): $mod = ($i % 2 );++$i;?><div class="note_list">
                    <dl>
                        <dt><a href="__GROUP__/Myzone/mymessage?id=<?php echo ($uid); ?>" id="author">
                            <img src="__PUBLIC__/Uploads/<?php echo ($in["postphoto"]); ?>" alt="<?php echo ($in["postname"]); ?>" />
                        </a>
                        </dt>
                        <dd>
                            <ul>
				...
				<span class="fr">
                    ...
                    <a href="javascript:void(0);" onclick="reply_content(1073)" >回复</a>　<a  href="__GROUP__/Myzone/mbdel?id=<?php echo ($in["id"]); ?>" >删除</a>
				</span>
                                    <a href="showuser.php?uid=6328" id="author"><?php echo ($in["postname"]); ?></a>
