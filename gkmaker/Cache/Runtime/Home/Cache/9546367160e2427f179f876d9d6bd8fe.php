...
<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><div style="width:850px; height:20px;"></div>
<div class="wrap">
 <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><div class="side">
    ...
    <div class="per_notebook">
        <h1 class="tit_3">
            <a href="http://www.kjjlpt.com/my.php?show=notice">比赛通知</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">站内通知</a>
        </h1>
