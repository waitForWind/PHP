...
<body><iframe style="display: none; " frameborder="0"></iframe><div id="bdshare" style="right: 0px; top: 52.5px; position: fixed; height: 330px; overflow: hidden; "><img src="./通知--大学生科技交流平台_files/r4.gif" alt="" style="float:left;margin-top:58px;"><iframe id="bdsIfr" style="position:absolute;display:none;z-index:9999;" frameborder="0"></iframe><div id="bdshare_l" style="display: none; left: 24px; "><div id="bdshare_l_c"><h6>分享到</h6><ul><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_mshare mshare">一键分享</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_qzone qqkj">QQ空间</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_tsina xlwb">新浪微博</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_bdysc bdysc">百度云收藏</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_renren rrw">人人网</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_tqq txwb">腾讯微博</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_bdxc bdxc">百度相册</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_kaixin001 kxw">开心网</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_tqf txpy">腾讯朋友</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_tieba bdtb">百度贴吧</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_douban db">豆瓣网</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_tsohu shwb">搜狐微博</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_bdhome bdhome">百度新首页</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_sqq sqq">QQ好友</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_thx thx">和讯微博</a></li><li><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="bds_more">更多...</a></li></ul><p><a href="http://www.kjjlpt.com/my.php?show=allnotice#" class="goWebsite">百度分享</a></p></div></div></div>
...
<script src="__PUBLIC__/js/kindlimit.js" type="text/javascript"></script>
...
<div class="wrap">
    ...
    <div class="right">
        <div class="per_notebook">
            <h2 class="tit_3">发私信</h2>
            <form action="__GROUP__/Myzone/sendmsg" method="post" id="send_msg">
                <table border="0" cellspacing="0" cellpadding="0" class="table_1">
                    <colgroup><col width="70" /><col /></colgroup>
                    <tr>
                        <th>收信人：</th>
                        <td>
                            <input type="hidden" value="<?php echo ($name[0]["uid"]); ?>" name="msg[get]"/>
                            <input type="text" class="input_2" value="<?php echo ($name[0]["email"]); ?>"/>
                            <span id="user_error" class="obli"></span></td>
                    </tr>
                    <tr>
                        <th>内容：</th>
                        <td>
                            <span id="msg"></span>
                       <textarea id="content" class="input" style="height: 250px; width: 100%;" name="msg[content]"></textarea></td>

                            <!--<textarea name="msg[content]" class="text_2" id="reply_content"></textarea></td>-->

                    </tr>
                    <tr>
                        <td colspan="2" class="tc">
                            <input type="hidden" name="msg[s_uid]" value="6328" id="sender"/>
                            <input name="button" type="button" class="btn_2" value="发送" /></td>
                    </tr>
                </table>
            </form>
        </div>
