              ...
              <div class="news_L">
                ...
                <div class="news_L_a">
                  <div class="news_L_a_top">
                    <div class="place">
                      当前位置：
                      <a href="index.php">首页</a> > <strong>公告中心</strong>
                    </div>
                  </div>
                  ...
                  <div class="look">
                    ...
                    <div class="ninfo">
                      日期：<?php echo (date("Y-m-d H:i:s",$info["updata_time"])); ?>&nbsp;&nbsp;&nbsp;浏览次数:204
                    </div>
  ...
  <div class="news_R_b">
    ...
    <div class="jieshu_c">
      ...
      <div class="footer">
        ...
        <br /> Copyright 2014-2015&nbsp;by&nbsp;<a href="__GROUP__/Ourmaker/index" target="_blank">柳州maker</a>&nbsp;All&nbsp;Rights&nbsp;Reserved&nbsp;&nbsp;
