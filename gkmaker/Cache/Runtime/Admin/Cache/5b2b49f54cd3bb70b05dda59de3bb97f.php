...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='科技新闻管理 > 下载文件管理'; ?>
				...
				<div class="Item hr">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td width="200px"><a style="color:red"href="__URL__/dowfile?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["filename"]); ?></a></td>
                                <td><?php if($vo["status"]): ?>已发布状态<?php else: ?>审核状态<?php endif; ?></td>
                                <td><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>                       
                                <td>[<a href="__URL__/putout2?id=<?php echo ($vo["id"]); ?>"><?php if($vo["status"]): ?>取消发布<?php else: ?>点击发布<?php endif; ?></a>][ <a href="__URL__/editDownload?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="<?php echo U('Science/delDownload/',array('id'=>$vo['id']));?>" href="javascript:void(0)" class="del">删除 </a> ]</td>
