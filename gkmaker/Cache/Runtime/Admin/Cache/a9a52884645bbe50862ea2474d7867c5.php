...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='创客联盟 > 创客介绍'; ?>
...
<div class="clear"></div>
    ...
    <div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">添加创客介绍</div>
                    </div>
                    <form action="__URL__/edit" method="post">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr>
                                <th width="100">创客口号</th>
                                <td><input id="title" type="text" class="input" size="60" name="info[slogan]" value="<?php echo ($info["slogan"]); ?>"/> </td>
                            </tr>
                            <tr>
                                <th>创客介绍：</th>
                                <td><textarea id="content1" class="input" style="height: 300px; width: 100%;" name="info[introduce]"><?php echo ($info["introduce"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>创客目标：</th>
                                <td><textarea id="content2" class="input" style="height: 300px; width: 100%;" name="info[aim]"><?php echo ($info["aim"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>创客历史：</th>
                                <td><textarea id="content4" class="input" style="height: 300px; width: 100%;" name="info[history]"><?php echo ($info["history"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>创客成绩：</th>
                                <td><textarea id="content3" class="input" style="height: 300px; width: 100%;" name="info[score]"><?php echo ($info["score"]); ?></textarea></td>
                            </tr>
        ...
        <script type="text/javascript">
            $(function(){var  content ;
                KindEditor.ready(function(K) {
                    ...
                    content = K.create('#content1');
                    content = K.create('#content2');
                    content = K.create('#content3');
                    content = K.create('#content4');
                });
