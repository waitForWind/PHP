...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>添加、编辑公告-后台管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='公告管理 > 添加编辑公告'; ?>
...
<div class="clear"></div>
    ...
    <div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">添加编辑公告</div>
                    </div>
                    <form action="<?php echo U('Admin/Relannounce/showout');?>" method="post">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr>
                                <th width="100">公告标题：</th>
                                <td><input id="title" type="text" class="input" size="60" name="info[title]" value="<?php echo ($info["title"]); ?>"/> 
                            </tr>

                            <tr>
                                <th width="100">公告发布状态：</th>
