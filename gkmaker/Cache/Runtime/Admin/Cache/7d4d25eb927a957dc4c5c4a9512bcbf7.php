...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='网站注册会员管理 > 编辑会员信息'; ?>
                ...
                <form>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        <tr>
                            <td>帐号:</td>
                            <td>
                                <input id="nickname" class="input" type="text" name="memb[nickname]" value="<?php echo ($info["nickname"]); ?>" size="25"/>
                            </td>
                            <td>真实姓名:</td>
                            <td>
                                <input type="text" class="input" name="memb[truename]" value="<?php echo ($info["truename"]); ?>" size="25" />
                            </td>
                            <td>密码:</td>
                            <td>
                                <input type="text" class="input" name="memb[pwd]" size="25"/>
                            </td>
                        </tr>
                        <tr>
                            <td>性别:</td>
                            <td>
                            <?php if($info["sex"] != NULL): if($info["sex"] == 1): ?><input type="radio" name="memb[sex]" checked="checked" value="1" />
                                    男 &nbsp;
                                    <input type="radio" name="memb[sex]"  value="0" />
                                    女
                                    <?php else: ?>
                                    <input type="radio" name="memb[sex]" value="1" />
                                    男 &nbsp;
                                    <input type="radio" name="memb[sex]"  checked="checked" value="0" />
                                    女<?php endif; endif; ?>
                            </td>
                            <td>手机:</td>
                            <td>
                                <input type="text" class="input" name="memb[phone]" value="<?php echo ($info["phone"]); ?>" size="25" />
                            </td>
                            <td>QQ:</td>
                            <td>
                                <input type="text" class="input" name="memb[qq]" value="<?php echo ($info["qq"]); ?>" size="25" />
                            </td>
                        </tr>
                        <tr>
                            <td>个人简介:</td>
                            <td>
                                <input type="text" class="input" name="memb[intr]" value="<?php echo ($info["intr"]); ?>" size="25" />
                            </td>
                        </tr>
