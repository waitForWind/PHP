...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='咨询管理 > 预览图片'; ?>
...
<div class="clear"></div>
    ...
    <div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">图片预览</div>
                    </div>     

                     大图<img src="__PUBLIC__/Uploads/m_<?php echo ($filename); ?>" style="border:1px solid black"/>  
                     小图<img src="__PUBLIC__/Uploads/s_<?php echo ($filename); ?>" style="border:1px solid black" />
