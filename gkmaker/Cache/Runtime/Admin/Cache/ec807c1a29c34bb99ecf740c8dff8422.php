                    ...
                    <form  method="post"  enctype="multipart/form-data">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr>
                             ...
                             <tr>
                                <th>文章配图：</th>
                                <td> <input type="file" name="file"  value="<?php echo ($info["filename"]); ?>" />允许上传的格式为jpg', 'gif', 'png', 'jpeg','ico'</td>                     
                             </tr>
                            ...
                            <tr>
                                <th width="100">网站大屏幕：</th>
                                <td><label><input type="radio" name="info[is_screen]" value="0" <?php if($info["status"] == 0): ?>checked="checked"<?php endif; ?> /> 否</label> &nbsp; <label><input type="radio" name="info[is_screen]" value="1" <?php if($info["status"] == 1): ?>checked="checked"<?php endif; ?> /> 是</label> </td>
                            </tr>
                        ...
                        <input type="submit" value="提交" style="width: 100px; background: rgb(65, 126, 183) none repeat scroll 0px 0px; height: 40px; border-radius: 5px; color: white;"> 
                    </div>
                    </form>
