...
<head>
    ...
    <?php $addCss=""; $addJs=""; $currentNav ='网站注册会员管理 > 个人会员列表'; ?>
                    ...
                    <form action="__URL__/search" method="post">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr align="left">
                                ...
                                <td width="22%">
                                    <input type="text" name="keyword" size="30" class="input"/>
                                </td>
                                <td width="9%">
                                    <select name="kind">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form>
                            <tr align="center">
                                ...
                                <td>
                                    <?php if($vo['sex'] != NULL): if($vo['sex'] == 0): ?>女
                                            <?php else: ?>
                                            男<?php endif; endif; ?>
                                </td>
                                ...
                                <td>
                                    <a href="__URL__/isvip?id=<?php echo ($vo["uid"]); ?>">
                                        <?php if($vo['isvip'] == 1): ?>[是]
                                            <?php else: ?>
                                            [否]<?php endif; ?>
                                    </a>
