...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='科技新闻管理 > 添加编辑下载文件'; ?>
...
<div class="clear"></div>
    ...
    <div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">添加编辑下载文件</div>
                    </div>
                    <form action="__GROUP__/Science/addDownload" method="post" enctype="multipart/form-data">
                <table border="0">
                    <tbody>
                    <tr><td width="79" align="right">文件标题:</td><td width="186"><input type="text" value="<?php echo ($info['title']); ?>" name="title" style="border-color: rgb(207, 207, 207); color: rgb(0, 0, 0); "></td></tr>
                    <tr>
