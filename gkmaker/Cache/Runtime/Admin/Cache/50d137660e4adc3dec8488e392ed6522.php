...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>添加、编辑科技新闻-后台管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='科技新闻管理 > 添加编辑科技新闻'; ?>
...
<div class="clear"></div>
    ...
    <div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">添加编辑科技新闻</div>
                    </div>
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            ...
                            <tr>
                                <th>文章关键词：</th>
                                <td><input type="text" class="input" size="60" name="info[keywords]" value="<?php echo ($info["keywords"]); ?>"/> </td>
                            </tr>
    ...
    $(function(){
        ...
        <script type="text/javascript">
            $(function(){var  content ;
                ...
                $("#checkScienceTitle").click(function(){
                    $.getJSON("__URL__/checkScienceTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
                        $("#checkScienceTitle").css("color",json.status==1?"#0f0":"#f00").html(json.info);
                    });
                });
