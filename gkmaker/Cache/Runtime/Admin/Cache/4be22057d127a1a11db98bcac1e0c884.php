...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='创意管理 > 创意列表'; ?>
                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                [ <a href="__URL__/edit?id=<?php echo ($vo["id"]); ?>">编辑</a> ] [ <a link="<?php echo U('Zonenotice/del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="" class="del">删除</a> ]</td>
