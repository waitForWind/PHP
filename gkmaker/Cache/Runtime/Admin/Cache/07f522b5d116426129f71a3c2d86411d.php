            ...
            <div id="Right">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                            ...
                            <td>
                                [
                                <a href="__URL__/putout3?id=<?php echo ($vo["id"]); ?>">
                                    <?php if($vo["status"]): ?>取消发布
                                        <?php else: ?>
                                        点击发布<?php endif; ?>
                                </a>
                                ][
                                <a href="__URL__/addIntroduction?id=<?php echo ($vo["id"]); ?>">编辑</a>
                                ] [
                                <a link="<?php echo U('Science/delIntroduction/',array('id'=>$vo['id']));?>"  name="<?php echo ($vo["title"]); ?>" class="del">删除</a>
                                ]
                            </td>
