...
<link rel="stylesheet" type="text/css" href="./templates/css/list.css" /><link rel="stylesheet" type="text/css" href="./templates/css/.css" />
                        ...
                        <div class="news_L_top">
                         ...
                         <div class="news_L_a">
                          ...
                          <div class="news_L_a_top">
                            <div class="place">当前位置：<a href="index.php">首页</a> > <strong>名师讲座</strong></div>
                          </div>
                          
                          
                          <div class="news_L_a_kongge">
                          </div>
                          <div class="news_L_a_b">
                              <div class="news_L_a_b_left">
                              </div>
                             
                               <div class="news_L_a_b_tu">
                               <img src="./templates/images/newslistgb.jpg" />
                                                             </div>
                           <div class="news_L_a_b_wen">
                                  <h3><a href="shownews.php?show=news&nid=137">哈尔滨工业大学吴少华受聘我校客座教授并讲学</a></h3>
                                  <span></span>
                              </div>
                          ...
                          <div class="news_L_a_c">
                            <ul>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                      <a  href="shownews.php?show=teacher&nid=<?php echo ($vo["id"]); ?>">
                         ...
                         <div class="fanyelist"><?php echo ($page); ?></div>
                          </div>
                      ...
                      <div class="news_R_a">
                        ...
                        <div class="news_R_a_M">
                            ...
                            <div class="news_R_a_M_m">
                             <ul>
                                                               <li><a href="shownews.php?show=news&nid=206">dreamweaver 配色方案</a><!--<span>2013-06-14</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=183">Windows下C语言的Sock</a><!--<span>2013-05-13</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=244">win8,win7安装matla</a><!--<span>2014-03-01</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=270">云作坊“掌上通”项目在“创青春”</a><!--<span>2014-05-26</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=161">长理掌上通</a><!--<span>2013-04-25</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=137">哈尔滨工业大学吴少华受聘我校客座</a><!--<span>2012-12-10</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=265">云作坊“掌上通”项目在“创青春”</a><!--<span>2014-04-03</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=145">四川外语学院胡安江教授、熊沐清教</a><!--<span>2012-12-28</span>--></li>
                             ...
                             <div class="news_R_b_a_A">
                                 ...
                                 <ul>
                                                                   <li><a href="shownews.php?show=news&nid=275">全国“挑战杯”大学生课外艺术作品竞赛作</a><!--<span>2014-06-30</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=274">云作坊重新回归计通学院</a><!--<span>2014-06-28</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=272">win8.1去除开始按钮</a><!--<span>2014-06-16</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=271">人工生物识别码的设想</a><!--<span>2014-06-10</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=270">云作坊“掌上通”项目在“创青春”暨挑战</a><!--<span>2014-05-26</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=268">长沙理工大学第六届“守正杯”辩论赛8进</a><!--<span>2014-04-28</span>--></li>
                                                                    <li><a href="shownews.php?show=news&nid=267">云作坊举行四周年定向越野活动</a><!--<span>2014-04-17</span>--></li>
                                                                   </ul>
                             </div>
                         </div>
